...
use Tateren\PhpAlgorithms\DataStructures\DoublyLinkedList\DoublyLinkedListNode;
...
it('should create list node with object as a value', function () {
    ...
    $node = new DoublyLinkedListNode($nodeValue);
...
it('should link nodes together', function () {
    ...
    $node1 = new DoublyLinkedListNode(1, $node2);
    $node3 = new DoublyLinkedListNode(10, $node1, $node2);
    ...
    expect($node3->previous)->not()->toBeNull();
