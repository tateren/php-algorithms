...
use Tateren\PhpAlgorithms\DataStructures\Tree\AvlTree\AvlTree;
...
it('should do left right rotation and keeping left right node safe 2', function () {
    $tree = new AvlTree();
...
it('should keep balance after removal', function () {
    ...
    expect($tree->contains(8))->toBeFalse();
    expect($tree->contains(9))->toBeFalse();
